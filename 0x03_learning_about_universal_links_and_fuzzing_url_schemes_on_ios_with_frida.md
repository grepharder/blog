...
<center><img src="img/0x03/forbidden_universal_link_twitte.gif" title="Forbidden Universal Link"></center>

Opening (`/account/access`) shows options to open it in Safari and in Twitter:

<center><img src="img/0x03/allowed_universal_link_twitte.gif" title="Allowed Universal Link"></center>
